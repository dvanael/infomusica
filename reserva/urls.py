...
urlpatterns = [
    ...
    path('password/', PasswordEdit.as_view(template_name = 'registration/change-password.html'), name = 'mudar-senha'),
    path('mudar-grupo/<int:pk>/', change_group, name = 'mudar-grupo'),
